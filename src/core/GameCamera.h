...
private:
    ...
    //////////////////////////////////////////////////
    void movementUpdate(float deltatime); // BUG Когда камера касается верхних-нижних границ и игрок бегает из стороны в сторону, то камера начинает качаться. Так не должно быть. Проблема в targetPos или тип того.
