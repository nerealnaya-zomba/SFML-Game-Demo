...
int main()
{
    ...
    decoration.addDecoration("plant1",{100,1040+offset},scale,parrallaxF/randomParallax,0, grassColor);
    randomParallax = random(1.2f,1.8);
    scale = {(randomParallax/0.1f)/grassSizeReduction, (randomParallax/0.1f)/grassSizeReduction};
    decoration.addDecoration("plant2",{200,1055+offset},scale, parrallaxF/randomParallax,0, grassColor);
    randomParallax = random(1.2f,1.8);
    scale = {(randomParallax/0.1f)/grassSizeReduction, (randomParallax/0.1f)/grassSizeReduction};
    decoration.addDecoration("plant3",{300,1035+offset},scale, parrallaxF/randomParallax,0, grassColor);
    randomParallax = random(1.2f,1.8);
    scale = {(randomParallax/0.1f)/grassSizeReduction, (randomParallax/0.1f)/grassSizeReduction};
    decoration.addDecoration("plant1",{400,1040+offset},scale,parrallaxF/randomParallax,0, grassColor);
    randomParallax = random(1.2f,1.8);
    scale = {(randomParallax/0.1f)/grassSizeReduction, (randomParallax/0.1f)/grassSizeReduction};
    decoration.addDecoration("plant2",{500,1055+offset},scale, parrallaxF/randomParallax,0, grassColor);
    randomParallax = random(1.2f,1.8);
    scale = {(randomParallax/0.1f)/grassSizeReduction, (randomParallax/0.1f)/grassSizeReduction};
    decoration.addDecoration("plant3",{600,1035+offset},scale,parrallaxF/randomParallax,0, grassColor);
    randomParallax = random(1.2f,1.8);
    scale = {(randomParallax/0.1f)/grassSizeReduction, (randomParallax/0.1f)/grassSizeReduction};
    decoration.addDecoration("plant1",{700,1058+offset},scale, parrallaxF/randomParallax,0, grassColor);
    randomParallax = random(1.2f,1.8);
    scale = {(randomParallax/0.1f)/grassSizeReduction, (randomParallax/0.1f)/grassSizeReduction};
    decoration.addDecoration("plant2",{800,1045+offset},scale,parrallaxF/randomParallax,0, grassColor);
    randomParallax = random(1.2f,1.8);
    scale = {(randomParallax/0.1f)/grassSizeReduction, (randomParallax/0.1f)/grassSizeReduction};
    decoration.addDecoration("plant3",{1000,1048+offset},scale, parrallaxF/randomParallax,0, grassColor);
    randomParallax = random(1.2f,1.8);
    scale = {(randomParallax/0.1f)/grassSizeReduction, (randomParallax/0.1f)/grassSizeReduction};
    decoration.addDecoration("plant2",{1100,1055+offset},scale, parrallaxF/randomParallax,0, grassColor);
    randomParallax = random(1.2f,1.8);
    scale = {(randomParallax/0.1f)/grassSizeReduction, (randomParallax/0.1f)/grassSizeReduction};
    decoration.addDecoration("plant3",{1200,1035+offset},scale,parrallaxF/randomParallax,0, grassColor);
    randomParallax = random(1.2f,1.8);
    scale = {(randomParallax/0.1f)/grassSizeReduction, (randomParallax/0.1f)/grassSizeReduction};
    decoration.addDecoration("plant1",{1300,1058+offset},scale,parrallaxF/randomParallax,0, grassColor);
    randomParallax = random(1.2f,1.8);
    scale = {(randomParallax/0.1f)/grassSizeReduction, (randomParallax/0.1f)/grassSizeReduction};
    decoration.addDecoration("plant2",{1400,1045+offset},scale,parrallaxF/randomParallax,0, grassColor);
    randomParallax = random(1.2f,1.8);
    scale = {(randomParallax/0.1f)/grassSizeReduction, (randomParallax/0.1f)/grassSizeReduction};
    decoration.addDecoration("plant3",{1500,1048+offset},scale, parrallaxF/randomParallax,0, grassColor);
    randomParallax = random(1.2f,1.8);
    scale = {(randomParallax/0.1f)/grassSizeReduction, (randomParallax/0.1f)/grassSizeReduction};
    decoration.addDecoration("plant3",{1600,1035+offset},scale,parrallaxF/randomParallax,0, grassColor);
    randomParallax = random(1.2f,1.8);
    scale = {(randomParallax/0.1f)/grassSizeReduction, (randomParallax/0.1f)/grassSizeReduction};
    decoration.addDecoration("plant1",{1700,1058+offset},scale, parrallaxF/randomParallax,0, grassColor);
    randomParallax = random(1.2f,1.8);
    scale = {(randomParallax/0.1f)/grassSizeReduction, (randomParallax/0.1f)/grassSizeReduction};
    decoration.addDecoration("plant2",{1800,1045+offset},scale,parrallaxF/randomParallax,0, grassColor);
    randomParallax = random(1.2f,1.8);
    scale = {(randomParallax/0.1f)/grassSizeReduction, (randomParallax/0.1f)/grassSizeReduction};
    decoration.addDecoration("plant3",{1900,1048+offset},scale, parrallaxF/randomParallax,0, grassColor);
    randomParallax = random(1.2f,1.8);
    scale = {(randomParallax/0.1f)/grassSizeReduction, (randomParallax/0.1f)/grassSizeReduction};
